  ...
  if (isset($_GET['control']) && !empty($_GET['control'])) {
    ...
    <div class="row justify-content-center">
      <div class="col-lg-12 mt-3 mb-3">
          ...
          <form  action="#" method="post" id="dataFormMothers" class="px-3">
            <div class="row">
         ...
         <h3 class="text-muted text-center">Data Form Info</h3><hr>
          <div id="showError">
			...
			<strong class="text-center">For Qualification, Leave blank if the mother does not have any! and For Last Year of Training select <span class="text-danger">0000</span> if the mother have not undergo any training!</strong>
			</div>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              <label for="form-control">Mom's Name <sup class="text-danger">*</sup></label>
           ...
           <small class="text-muted">If mother does not have state ID thick this box</small>
            ...
            <div class="form-group col-md-6">
              <input type="submit" name="addMother" id="addMotherBtn" value="Add Mother" class="btn btn-info btn-block btn-lg">
            </div>
            <div class="col-md-6">
...
<script type="text/javascript">
  $(document).ready(function(){
    //send feedback ajax
      $('#addMotherBtn').click(function(e){
      if($('#dataFormMothers')[0].checkValidity()){
        e.preventDefault();
          $(this).val('Please wait...');
          $.ajax({
            url: '../data-process.php',
            method: 'post',
            data: $('#dataFormMothers').serialize()+'&action=addInfoMother',
            success:function(response){
              console.log(response);
              if ($.trim(response) === 'true') {
                $('#dataFormMothers')[0].reset();
                $('#addMotherBtn').val('Add Mother');
                $('#showError').html('<span class="text-success">Mother Added!</span>');
