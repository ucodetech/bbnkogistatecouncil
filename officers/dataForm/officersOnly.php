  ...
  if (isset($_GET['control']) && !empty($_GET['control'])) {
    ...
    <div class="row justify-content-center">
      <div class="col-lg-12 mt-3 mb-3">
          ...
          <form  action="#" method="post" id="dataFormOfficers" class="px-3">
            <div class="row">
         ...
         <h3 class="text-muted text-center">Data Form Info</h3><hr>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              <label for="form-control">Name of Officer <sup class="text-danger">*</sup></label>
           ...
           <small class="text-muted">If the officer does not have state ID thick this box</small>
            </div>
            ...
            <div class="form-group col-md-6">
              <input type="submit" name="addOfficers" id="addOfficerBtn" value="Add Officer" class="btn btn-info btn-block btn-lg">
            </div>
            <div class="col-md-6">
...
<script type="text/javascript">
  $(document).ready(function(){
    //send feedback ajax
      ...
      if($('#dataFormOfficers')[0].checkValidity()){
        e.preventDefault();
          $(this).val('Please wait...');
          $.ajax({
            url: '../data-process.php',
            method: 'post',
            data: $('#dataFormOfficers').serialize()+'&action=addInfoOfficer',
            success:function(response){
              console.log(response);
              if ($.trim(response) === 'true') {
                $('#dataFormOfficers')[0].reset();
                $('#addOfficerBtn').val('Add Officer');
                $('#showError').html('<span class="text-success">Officer Added!</span>');
